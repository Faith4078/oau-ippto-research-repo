...
export const workspaces: Record<DashboardRole, DashboardWorkspace> = {
	...
	"faculty-admin": {
		...
		description:
			"Review research across departments, approve work that is ready, and understand faculty progress.",
		...
		tabs: ["Needs review", "Reports", "Departments", "Decisions"],
		rows: sharedRows,
		emptyTitle: "No research matches these filters",
		emptyText:
			"Clear the filters or choose another department to see more research.",
		emptyAction: "Clear Filters",
		quickActions: [
			{ label: "Approve selected research", icon: BadgeCheck },
		...
		sections: [
			{
				...
				text: "Compare research and innovations by department, type, and review progress.",
				icon: Network,
			},
			{
